...
describe 'Items Search API' do
  ...
  it 'can search for min price' do
    merchant_1 = create(:merchant)
    item_1 = create(:item, name: 'Flaming Moe', unit_price: 899, merchant_id: merchant_1.id)
    item_2 = create(:item, name: 'Flaming Homer', unit_price: 999, merchant_id: merchant_1.id)
    item_3 = create(:item, name: 'Something something flaming', unit_price: 399,
                           merchant_id: merchant_1.id)
    item_4 = create(:item, name: 'Duff', unit_price: 299, merchant_id: merchant_1.id)
